...
//	 vPoperty_Size=16
	...
	unsigned long                                      mUseBattleRageValue : 1;                          		// 0x0008 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      mMultiplyWithBattleRage : 1;                      		// 0x0008 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      mUseMetamagicValue : 1;                           		// 0x0008 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      mMultiplyWithMetamagic : 1;                       		// 0x0008 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	struct FH7SpellScaling                             mScalingModifierValue;                            		// 0x000C (0x0014) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FH7LevelScalingRange >              mStatModLevelScalingValue;                        		// 0x0020 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FH7PurchaseAbleStatModCosts >       mStatModCosts;                                    		// 0x0030 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mMultiplyWithPathLength : 1;                      		// 0x0040 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      mShirneSeventhDragon : 1;                         		// 0x0040 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      mOverrideWithAnotherStat : 1;                     		// 0x0040 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned char                                      mStatToOverrideWith;                              		// 0x0044 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mModifyStatForCreature : 1;                       		// 0x0048 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class AH7Creature*                                 mModifyThatCreature;                              		// 0x004C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mModifyCreatureVersions : 1;                      		// 0x0054 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class UH7EffectContainer*                          mSource;                                          		// 0x0058 (0x0008) [0x0000000000000000]              
	float                                              mInitialModValue;                                 		// 0x0060 (0x0004) [0x0000000000000000]              
};
...
{
//	 vPoperty_Size=3
	struct FH7MeModifiesStat                           StatMod;                                          		// 0x0000 (0x0064) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UH7EffectContainer*                          Source;                                           		// 0x0064 (0x0008) [0x0000000000000000]              
	class UH7IEffectTargetable*                        Target;                                           		// 0x006C (0x0010) [0x0000000000000000]              
	unsigned char                                      UnknownData00[ 0x8 ];                             		// 0x0074 (0x0008) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
};
...
//	 vPoperty_Size=4
	...
	int                                                SkillRank;                                        		// 0x0010 (0x0004) [0x0000000000000000]              
	unsigned long                                      UltimateRequirment : 1;                           		// 0x0014 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                SkillID;                                          		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
//	 vPoperty_Size=7
	...
	int                                                mSaveGameCheckSum;                                		// 0x035C (0x0004) [0x0000000000000000]              
	unsigned long                                      mIsInitialized : 1;                               		// 0x0360 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      mIsDuel : 1;                                      		// 0x0360 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
//	 vPoperty_Size=11
	...
	float                                              mDamageModifier;                                  		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                mKillsLow;                                        		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                mKillsHigh;                                       		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                mKills;                                           		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                mAttackPower;                                     		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                mDefensePower;                                    		// 0x0020 (0x0004) [0x0000000000000000]              
	unsigned long                                      mIsCovered : 1;                                   		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      mMissed : 1;                                      		// 0x0024 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      mTriggerEvents : 1;                               		// 0x0024 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned char                                      mSchoolType;                                      		// 0x0028 (0x0001) [0x0000000000000000]              
	unsigned long                                      mConstDamageRange : 1;                            		// 0x002C (0x0004) [0x0000000000000000] [0x00000001] 
	TArray< struct FH7TooltipMultiplier >              mMultipliers;                                     		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UH7Effect* >                         mEffects;                                         		// 0x0040 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UH7Effect* >                         mTriggeredEffects;                                		// 0x0050 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=3
	...
	TArray< struct FIntPoint >                         mAffectedCells;                                   		// 0x0008 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UH7IEffectTargetable* >              mAffectedTargets;                                 		// 0x0018 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=24
	...
	unsigned long                                      UseHasAbility : 1;                                		// 0x0008 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
//	 vPoperty_Size=41
	...
	unsigned long                                      OwnerMustBeAdjacent : 1;                          		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      HPTargetDamaged : 1;                              		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      HPCheckForPercentage : 1;                         		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	...
	unsigned long                                      UseCreatureTypes : 1;                             		// 0x00EC (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	TArray< class AH7Creature* >                       CreatureTypes;                                    		// 0x00F0 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      UseTargetAreaUnoccupied : 1;                      		// 0x0100 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FIntPoint                                   TargetDimensions;                                 		// 0x0104 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
//	 vPoperty_Size=25
	...
	unsigned long                                      UseAttackInitiator : 1;                           		// 0x0050 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      InitiatorIsSelf : 1;                              		// 0x0050 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      UseAttackInitiatorBuff : 1;                       		// 0x0050 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      InitiatorIsBuffOwner : 1;                         		// 0x0050 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      UseAttackerAlignment : 1;                         		// 0x0050 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned char                                      UAOperation;                                      		// 0x0054 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      UAAlignment;                                      		// 0x0055 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      UseDefenderAlignment : 1;                         		// 0x0058 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned char                                      UDOperation;                                      		// 0x005C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      UDAlignment;                                      		// 0x005D (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      UseRetaliation : 1;                               		// 0x0060 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      WillRetaliate : 1;                                		// 0x0060 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      UnitHasBuffs : 1;                                 		// 0x0060 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned char                                      BuffsOp;                                          		// 0x0064 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UH7BaseBuff* >                       CTBuffs;                                          		// 0x0068 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      UseHasAbilities : 1;                              		// 0x0078 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned char                                      AbilitiesOp;                                      		// 0x007C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      AbilitiesLogic;                                   		// 0x007D (0x0001) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UH7BaseAbility* >                    HasAbilities;                                     		// 0x0080 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
//	 vPoperty_Size=6
	struct FH7CasterConditionStruct                    mExtededAbilityParameters;                        		// 0x0000 (0x00A8) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FH7ConditionStructExtendedTarget            mExtendedTargetParameters;                        		// 0x00A8 (0x010C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FH7ConditionStructExtendAttack              mExtendedAttackParameters;                        		// 0x01B4 (0x0090) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mConditionTarget : 1;                             		// 0x0244 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      mConditionAttack : 1;                             		// 0x0244 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      mConditionAbility : 1;                            		// 0x0244 (0x0004) [0x0000000000000000] [0x00000004] 
};
...
// ScriptStruct MMH7Game.H7StructsAndEnumsNative.H7FXStruct
// 0x00000094
struct FH7FXStruct
{
//	 vPoperty_Size=16
	unsigned long                                      mSkipQueue : 1;                                   		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class UParticleSystem*                             mVFX;                                             		// 0x0004 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UAkEvent*                                    mSFX;                                             		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UAkEvent*                                    mStopSFX;                                         		// 0x0014 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              mBaseScale;                                       		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mScaleWithTarget : 1;                             		// 0x0020 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned char                                      mFXPosition;                                      		// 0x0024 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mUseCasterPosition : 1;                           		// 0x0028 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FString                                     mSocketName;                                      		// 0x002C (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mNoDuplicateVFX : 1;                              		// 0x003C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      mIsPermanentFX : 1;                               		// 0x003C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned char                                      mFXAnimations;                                    		// 0x0040 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mChangeAnimSpeed : 1;                             		// 0x0044 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              mAnimationSpeed;                                  		// 0x0048 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mSunburstTileFX : 1;                              		// 0x004C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class UH7Effect*                                   mSource;                                          		// 0x0050 (0x0008) [0x0000000000000000]              
	float                                              mScale;                                           		// 0x0058 (0x0004) [0x0000000000000000]              
	unsigned long                                      isBeam : 1;                                       		// 0x005C (0x0004) [0x0000000000000000] [0x00000001] 
	struct FVector                                     Source;                                           		// 0x0060 (0x000C) [0x0000000000000000]              
	struct FVector                                     Target;                                           		// 0x006C (0x000C) [0x0000000000000000]              
	struct FRotator                                    Rotation;                                         		// 0x0078 (0x000C) [0x0000000000000000]              
	TArray< struct FH7MaterialEffect >                 mMaterialFX;                                      		// 0x0084 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=9
	...
	struct FH7TriggerStruct                            mTrigger;                                         		// 0x002C (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FH7ConditionStruct                          mConditions;                                      		// 0x0038 (0x0248) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FH7FXStruct                                 mFX;                                              		// 0x0280 (0x0094) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mDontShowInTooltip : 1;                           		// 0x0314 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
{
//	 vPoperty_Size=3
	struct FH7RangeValue                               mDuration;                                        		// 0x0318 (0x0028) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mUseSpellScaling : 1;                             		// 0x0340 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FH7SpellScaling                             mDurationScaling;                                 		// 0x0344 (0x0014) [0x0000000000000001]              ( CPF_Edit )
};
...
{
//	 vPoperty_Size=2
	unsigned char                                      mCombineOperation;                                		// 0x0318 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	int                                                mModifierValue;                                   		// 0x031C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
//	 vPoperty_Size=3
	class UH7IEffectDelegate*                          mFunctionProvider;                                		// 0x0318 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      UnknownData00[ 0x8 ];                             		// 0x0320 (0x0008) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned long                                      mDoesDamage : 1;                                  		// 0x0328 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      mUseResist : 1;                                   		// 0x0328 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
};
...
// 0x0005(0x031D - 0x0318)
struct FH7ChargeEffect : FH7EffectProperties
{
//	 vPoperty_Size=2
	int                                                mChargeCounter;                                   		// 0x0318 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      mOp;                                              		// 0x031C (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
{
//	 vPoperty_Size=7
	unsigned char                                      mCommandTag;                                      		// 0x0318 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mInsertHead : 1;                                  		// 0x031C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                mAmount;                                          		// 0x0320 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UH7BaseAbility*                              mAbility;                                         		// 0x0324 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      mCommandRecipient;                                		// 0x032C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	struct FH7ConditionStructExtendedTarget            mRecipientConditions;                             		// 0x0330 (0x010C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mIgnoreAllegiance : 1;                            		// 0x043C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
{
//	 vPoperty_Size=17
	struct FH7RangeValue                               mDamage;                                          		// 0x0318 (0x0028) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mUseDefaultDamage : 1;                            		// 0x0340 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      mUseRandomSchool : 1;                             		// 0x0340 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      mUseMagicAbs : 1;                                 		// 0x0340 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      mUseDefaultSchool : 1;                            		// 0x0340 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      mUseAttackPower : 1;                              		// 0x0340 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      mUseDefensePower : 1;                             		// 0x0340 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      mUseResist : 1;                                   		// 0x0340 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned long                                      mIgnoreCover : 1;                                 		// 0x0340 (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      mUseStackSize : 1;                                		// 0x0340 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      mMultiplyByMetamagic : 1;                         		// 0x0340 (0x0004) [0x0000000000000001] [0x00000200] ( CPF_Edit )
	unsigned long                                      mUseStackSizeTarget : 1;                          		// 0x0340 (0x0004) [0x0000000000000001] [0x00000400] ( CPF_Edit )
	unsigned long                                      mUsePathLength : 1;                               		// 0x0340 (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	int                                                mMightBonusPerPathStep;                           		// 0x0344 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mUseSpellScaling : 1;                             		// 0x0348 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FH7SpellScaling                             mMinDamage;                                       		// 0x034C (0x0014) [0x0000000000000001]              ( CPF_Edit )
	struct FH7SpellScaling                             mMaxDamage;                                       		// 0x0360 (0x0014) [0x0000000000000001]              ( CPF_Edit )
	TArray< float >                                    mDistanceDamageReduction;                         		// 0x0374 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mUsePercentStackDamage : 1;                       		// 0x0384 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              mPercentStackDamage;                              		// 0x0388 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              mAddPercentStackDamage;                           		// 0x038C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              mPercentStackDamageCap;                           		// 0x0390 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mPercentUseCasterSpellPower : 1;                  		// 0x0394 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
{
//	 vPoperty_Size=1
	struct FH7ResistanceStruct                         mResistance;                                      		// 0x0318 (0x001C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
//	 vPoperty_Size=1
	struct FH7SpellStruct                              mSpellStruct;                                     		// 0x0318 (0x0010) [0x0000000000000001]              ( CPF_Edit )
};
...
{
//	 vPoperty_Size=2
	struct FH7MeModifiesStat                           mStatMod;                                         		// 0x0318 (0x0064) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      mUseAmount : 1;                                   		// 0x037C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
{
//	 vPoperty_Size=3
	struct FH7MeModifiesStat                           mMod;                                             		// 0x0000 (0x0064) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UH7EffectContainer*                          mSource;                                          		// 0x0064 (0x0008) [0x0000000000000000]              
	struct FString                                     mSourceName;                                      		// 0x006C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=13
	...
	float                                              UseSiteShop;                                      		// 0x0038 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              UseSiteStudy;                                     		// 0x003C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              UseSiteKeymaster;                                 		// 0x0040 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              UseSiteObelisk;                                   		// 0x0044 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Replenish;                                        		// 0x0048 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
//	 vPoperty_Size=5
	struct FH7AiHeroAgCompound2                        Standard;                                         		// 0x0000 (0x004C) [0x0000000000000001]              ( CPF_Edit )
	struct FH7AiHeroAgCompound2                        Explorer;                                         		// 0x004C (0x004C) [0x0000000000000001]              ( CPF_Edit )
	struct FH7AiHeroAgCompound2                        Gatherer;                                         		// 0x0098 (0x004C) [0x0000000000000001]              ( CPF_Edit )
	struct FH7AiHeroAgCompound2                        Homeguard;                                        		// 0x00E4 (0x004C) [0x0000000000000001]              ( CPF_Edit )
	struct FH7AiHeroAgCompound2                        General;                                          		// 0x0130 (0x004C) [0x0000000000000001]              ( CPF_Edit )
};
...
//	 vPoperty_Size=4
	...
	class AH7AreaOfControlSiteLord*                    targetLord;                                       		// 0x000C (0x0008) [0x0000000000000000]              
...
//	 vPoperty_Size=5
	...
	unsigned char                                      cursorDirection;                                  		// 0x0018 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	int                                                cursorAngle;                                      		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      extendedVersion : 1;                              		// 0x0020 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
{
//	 vPoperty_Size=8
	struct FCreatureStackProperties                    StackInfo;                                        		// 0x0000 (0x0014) [0x0000000000000000]              
	class AH7CreatureStack*                            CreatureStackRef;                                 		// 0x0014 (0x0008) [0x0000000000000000]              
	int                                                SourceSlotId;                                     		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                DistanceSide;                                     		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                DistanceTop;                                      		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                Ordinal;                                          		// 0x0028 (0x0004) [0x0000000000000000]              
	int                                                SpacingTop;                                       		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                SpacingBottom;                                    		// 0x0030 (0x0004) [0x0000000000000000]              
};
...
{
//	 vPoperty_Size=5
	unsigned long                                      ForceAutodeployment : 1;                          		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                OriginalMapHeight;                                		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                NumberOfDeployedStacks;                           		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                NumberOfStacksToDeploy;                           		// 0x000C (0x0004) [0x0000000000000000]              
	TArray< struct FH7StackDeployment >                StackDeployments;                                 		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=6
	...
	int                                                SynchRNG;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                IDCounter;                                        		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                UnitsCount;                                       		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                ResCount;                                         		// 0x0010 (0x0004) [0x0000000000000000]              
	unsigned long                                      IsCombat : 1;                                     		// 0x0014 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
//	 vPoperty_Size=11
	...
	class UH7IEffectTargetable*                        Target;                                           		// 0x0018 (0x0010) [0x0000000000000000]              
	unsigned char                                      UnknownData01[ 0x8 ];                             		// 0x0020 (0x0008) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	TArray< class UH7BaseCell* >                       Path;                                             		// 0x0028 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UH7BaseAbility*                              Ability;                                          		// 0x0038 (0x0008) [0x0000000000000000]              
	unsigned char                                      Direction;                                        		// 0x0040 (0x0001) [0x0000000000000000]              
	unsigned long                                      ReplaceFakeAttacker : 1;                          		// 0x0044 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      InsertHead : 1;                                   		// 0x0044 (0x0004) [0x0000000000000000] [0x00000002] 
	int                                                UnitTurnCounter;                                  		// 0x0048 (0x0004) [0x0000000000000000]              
	int                                                TeleportTarget;                                   		// 0x004C (0x0004) [0x0000000000000000]              
	int                                                CurrentPlayer;                                    		// 0x0050 (0x0004) [0x0000000000000000]              
	class UH7CombatMapCell*                            TrueHitCell;                                      		// 0x0054 (0x0008) [0x0000000000000000]              
	unsigned long                                      doOOSCheck : 1;                                   		// 0x005C (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                movementPoints;                                   		// 0x0060 (0x0004) [0x0000000000000000]              
	float                                              CreationTime;                                     		// 0x0064 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct MMH7Game.H7StructsAndEnums.AiActionScore
// 0x00000028
...
//	 vPoperty_Size=6
	...
	struct FString                                     mNameInst;                                        		// 0x002C (0x0010) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
};
...
{
//	 vPoperty_Size=4
	struct FKeyBind                                    KeyBind;                                          		// 0x0000 (0x001C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FKeyBind                                    secondaryKeybind;                                 		// 0x001C (0x001C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned char                                      Category;                                         		// 0x0038 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	struct FScriptDelegate                             keybindFunction;                                  		// 0x003C (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
//	 vPoperty_Size=1b
	...
	TArray< struct FString >                           SpellArchRefs;                                    		// 0x00F8 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=b
	...
	TArray< class AActor* >                            characterPoses;                                   		// 0x0008 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     matineeName;                                      		// 0x0018 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      isIvan : 1;                                       		// 0x0028 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class UAkEvent*                                    StartCampaignVoiceOver;                           		// 0x002C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UAkEvent*                                    ContinueCampaignVoiceOver;                        		// 0x0034 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UAkEvent*                                    RestartCampaignVoiceOver;                         		// 0x003C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UAkEvent* >                          StartCampaignConfirmEvent;                        		// 0x0044 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UAkEvent* >                          ContinueCampaignConfirmEvent;                     		// 0x0054 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UAkEvent* >                          RestartCampaignConfirmEvent;                      		// 0x0064 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UAkEvent* >                          IvanCampaignSelectEvent;                          		// 0x0074 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
//	 vPoperty_Size=1
	struct FH7Keybind                                  KeyBind;                                          		// 0x0000 (0x004C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=9
	...
	struct FOptionKeyStruct                            keybindFunctions;                                 		// 0x0098 (0x004C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=14
	...
	unsigned long                                      UseErosionMapCapture : 1;                         		// 0x007C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      UseTemplate : 1;                                  		// 0x007C (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
...
//	 vPoperty_Size=4
	...
	struct FH7PerlinNoiseProperties                    DecoNoise;                                        		// 0x0008 (0x002C) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      UseErosionMapCapture : 1;                         		// 0x0034 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
//	 vPoperty_Size=a
	...
	class UAkEvent*                                    mStartVoiceOver;                                  		// 0x002C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UAkEvent*                                    mStopVoiceOver;                                   		// 0x0034 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
