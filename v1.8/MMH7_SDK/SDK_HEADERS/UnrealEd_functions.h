...
bool UBrushBuilder::eventBuild ( )
{
	...
	if ( ! pFnBuild )
		pFnBuild = (UFunction*) UObject::GObjObjects()->Data[ 47362 ];
...
void UBrushBuilder::PolyEnd ( )
{
	...
	if ( ! pFnPolyEnd )
		pFnPolyEnd = (UFunction*) UObject::GObjObjects()->Data[ 47366 ];
...
void UBrushBuilder::Polyi ( int I )
{
	...
	if ( ! pFnPolyi )
		pFnPolyi = (UFunction*) UObject::GObjObjects()->Data[ 47368 ];
...
void UBrushBuilder::PolyBegin ( int Direction, struct FName ItemName )
{
	...
	if ( ! pFnPolyBegin )
		pFnPolyBegin = (UFunction*) UObject::GObjObjects()->Data[ 47369 ];
...
void UBrushBuilder::Poly4i ( int Direction, int I, int J, int K, int L, struct FName ItemName, unsigned long bIsTwoSidedNonSolid )
{
	...
	if ( ! pFnPoly4i )
		pFnPoly4i = (UFunction*) UObject::GObjObjects()->Data[ 47371 ];
...
void UBrushBuilder::Poly3i ( int Direction, int I, int J, int K, struct FName ItemName, unsigned long bIsTwoSidedNonSolid )
{
	...
	if ( ! pFnPoly3i )
		pFnPoly3i = (UFunction*) UObject::GObjObjects()->Data[ 47374 ];
...
int UBrushBuilder::Vertex3f ( float X, float Y, float Z )
{
	...
	if ( ! pFnVertex3f )
		pFnVertex3f = (UFunction*) UObject::GObjObjects()->Data[ 47382 ];
...
int UBrushBuilder::Vertexv ( struct FVector V )
{
	...
	if ( ! pFnVertexv )
		pFnVertexv = (UFunction*) UObject::GObjObjects()->Data[ 47389 ];
...
bool UBrushBuilder::BadParameters ( struct FString msg )
{
	...
	if ( ! pFnBadParameters )
		pFnBadParameters = (UFunction*) UObject::GObjObjects()->Data[ 47394 ];
...
int UBrushBuilder::GetPolyCount ( )
{
	...
	if ( ! pFnGetPolyCount )
		pFnGetPolyCount = (UFunction*) UObject::GObjObjects()->Data[ 47397 ];
...
struct FVector UBrushBuilder::GetVertex ( int I )
{
	...
	if ( ! pFnGetVertex )
		pFnGetVertex = (UFunction*) UObject::GObjObjects()->Data[ 47400 ];
...
int UBrushBuilder::GetVertexCount ( )
{
	...
	if ( ! pFnGetVertexCount )
		pFnGetVertexCount = (UFunction*) UObject::GObjObjects()->Data[ 47402 ];
...
bool UBrushBuilder::EndBrush ( )
{
	...
	if ( ! pFnEndBrush )
		pFnEndBrush = (UFunction*) UObject::GObjObjects()->Data[ 47405 ];
...
void UBrushBuilder::BeginBrush ( unsigned long InMergeCoplanars, struct FName InLayer )
{
	...
	if ( ! pFnBeginBrush )
		pFnBeginBrush = (UFunction*) UObject::GObjObjects()->Data[ 47407 ];
