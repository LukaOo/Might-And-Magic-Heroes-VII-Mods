...
// Class MMH7Engine.DynamicMaterialEffect ( Property size: 2 iter: 2) 
// Class name index: 7893 
// 0x0013 (0x0098 - 0x0085)
class UDynamicMaterialEffect : public UPostProcessEffect
{
public:
	class UMaterialInterface*                          ProcessMaterial;                                  		// 0x0088 (0x0008) [0x0000000000002000]              ( CPF_Transient )
	class ADynamicMaterialEffectVolume*                HighestPriorityVolume;                            		// 0x0090 (0x0008) [0x0000000001002002]              ( CPF_Const | CPF_Transient )
...
// Class MMH7Engine.H7AtmosphericEffectVolume ( Property size: 9 iter: 9) 
// Class name index: 7897 
...
public:
	...
	struct FVector4                                    mWindDirectionAndSpeed;                           		// 0x02B0 (0x0010) [0x0000000000000000]              
	float                                              mFogDensity;                                      		// 0x02C0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              mFogHeightFalloff;                                		// 0x02C4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              mFogOpacity;                                      		// 0x02C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              mFogStartDistance;                                		// 0x02CC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              mFogBrightness;                                   		// 0x02D0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                mFogColor;                                        		// 0x02D4 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      mUsedAsLayer : 1;                                 		// 0x02E4 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
