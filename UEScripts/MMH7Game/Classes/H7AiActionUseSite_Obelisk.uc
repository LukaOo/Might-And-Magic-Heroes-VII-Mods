//=============================================================================
// H7AiActionUseSite_Obelisk
//=============================================================================
// 
//=============================================================================
// Copyright 2013-2015 Limbic Entertainment All Rights Reserved.
//=============================================================================
class H7AiActionUseSite_Obelisk extends H7AiActionBase;
...
//	`LOG_AI("Action.UseSite_Obelisk");
	...
	if(hero!=None)
	{
		...
		{
			case HRL_GENERAL:   actionCfg = cfg.mAiAdvMapConfig.mConfigUseSiteObelisk.General; break;
			case HRL_MAIN:      actionCfg = cfg.mAiAdvMapConfig.mConfigUseSiteObelisk.Main; break;
			case HRL_SECONDARY: actionCfg = cfg.mAiAdvMapConfig.mConfigUseSiteObelisk.Secondary; break;
			case HRL_SCOUT:     actionCfg = cfg.mAiAdvMapConfig.mConfigUseSiteObelisk.Scout; break;
			case HRL_SUPPORT:   actionCfg = cfg.mAiAdvMapConfig.mConfigUseSiteObelisk.Support; break;
			case HRL_MULE:      actionCfg = cfg.mAiAdvMapConfig.mConfigUseSiteObelisk.Mule; break;
		}
	...
	tensionValue = hero.GetAdventureArmy().GetAiTensionValue(AID_UseSiteObelisk);
	...
	numSites=sic.GetObeliskSiteNum();
//	`LOG_AI("Num Keymaster Sites:" @ numSites );
	...
	{
//		`LOG_AI("  Site" @ sic.GetObeliskSite(k) );
		score.score =0.0f;
		score.dbgString = "Action.UseSite_Obelisk; " $ sic.GetObeliskSite(k) $ "; ";

		sic.SetTargetVisSite(sic.GetObeliskSite(k)); // that sets internally the targetArmy to
		sic.SetTargetCellAdv(sic.GetObeliskSite(k).GetEntranceCell());
...
//		`LOG_AI("  Available" @ ((utSiteAvailable[0] > 0.0f) ? "true" : "false") );
		if( utSiteAvailable.Length >= 1 && utSiteAvailable[0] > 0.0f )
		{
			...
			if(utAttackTarget.Length>=1 && utAttackTarget[0]>0.0f)
			{
				...
				score.score = utAttackTarget[0] * heroCfg.UseSiteObelisk * aocMod;
			}
