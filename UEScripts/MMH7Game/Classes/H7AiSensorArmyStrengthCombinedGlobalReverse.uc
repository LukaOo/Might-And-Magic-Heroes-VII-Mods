//=============================================================================
// H7AiSensorArmyStrengthCombinedReverseGlobal
//=============================================================================
// 
//=============================================================================
// Copyright 2013-2015 Limbic Entertainment All Rights Reserved.
//=============================================================================
class H7AiSensorArmyStrengthCombinedGlobalReverse extends H7AiSensorBase;
...
protected function bool ShouldCombine( H7AdventureArmy army, H7AdventureArmy receivingArmy )
{
	...
	local int threshold;
	local float armyStrength, strongestPotential, weakestReceiving, strongestPotentialCandidate, weakestReceivingCandidate;
	local bool hasSlots;
...
//	`LOG_AI("SAS::ShouldCombine() giving army" @ army @ army.GetHero() @ "receiving army" @ receivingArmy @ receivingArmy.GetHero() );
	...
	{
		strongestPotentialCandidate = class'H7AiActionCongregate'.static.GetStackStrengthGlobal( army.GetPlayer(), stack.GetStackType() );
	...
	foreach stacks( stack )
	{
		...
		{
			weakestReceiving = class'H7AiActionCongregate'.static.GetStackStrengthGlobal( army.GetPlayer(), stack.GetStackType() );
		}
		else
		{
			weakestReceivingCandidate = class'H7AiActionCongregate'.static.GetStackStrengthGlobal( army.GetPlayer(), stack.GetStackType() );
