//=============================================================================
// H7AiUtilityHeAbilityBurningDetermination
//=============================================================================
// Buff. Positive. Target creature stack gets a buff that lasts for the 
// creature's next 3 turns.
// Buff effect: The creature's morale is increased by:
...
//=============================================================================
class H7AiUtilityHeAbilityBurningDetermination extends H7AiUtilityCombiner;
...
//	`LOG_AI("Utility.HeAbilityBurningDetermination");
	...
	mUCreatureStat.mStat=TS_STAT_LEADERSHIP;
