//=============================================================================
// H7AiUtilityGeneralEffort
//=============================================================================
// 
//=============================================================================
// Copyright 2013-2015 Limbic Entertainment All Rights Reserved.
//=============================================================================
class H7AiUtilityGeneralEffort extends H7AiUtilityCombiner;
...
var H7AiUtilityFightingEffort     mInUFightingEffort;
...
function UpdateInput()
{
    ...
    if( mInUFightingEffort == None ) { mInUFightingEffort = new class 'H7AiUtilityFightingEffort'; }
    if( mInUTargetThreat == None ) {  mInUTargetThreat = new class 'H7AiUtilityAdvTargetThreat'; }

//	`LOG_AI("Utility.GeneralEffort");
	passed=false;
	...
	if(passed==false)
	{
		...
		if( movementEffort.Length>0 && movementEffort[0]>0.0f )
		{
			...
			mInUFightingEffort.mFMult=mFightingEffortModifier;
	...
	if(passed==true && movementEffort.Length>0 && fightingEffort.Length>0 && targetThreat.Length>0)
	{
		...
		dbgString = "GeneralEffort(" $ util $ ";ME(" $ movementEffort[0] $ "," $ mMovementEffortBias $ ");FE(" $ fightingEffort[0] $ "," $ mFightingEffortBias $  ");TT(" $ (1.0f-targetThreat[0]) $ ")) ";
	}
}
