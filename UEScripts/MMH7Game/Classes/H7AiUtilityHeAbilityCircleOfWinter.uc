//=============================================================================
// H7AiUtilityHeAbilityCircleOfWinter
//=============================================================================
//=============================================================================
// Copyright 2013-2015 Limbic Entertainment All Rights Reserved.
//=============================================================================
class H7AiUtilityHeAbilityCircleOfWinter extends H7AiUtilityCombiner;

var protected H7AiUtilitySpellAreaDamage  mUSpellDamage;

function H7CombatMapCell GetOptimalCircleOfWinterTargetCell(H7CombatHero hero, IntPoint dimension, bool isFilled )
{
	...
	for(x=0;x<(gridController.GetGridSizeX()-dimension.X);x++)
	{
		for(y=0;y<(gridController.GetGridSizeY()-dimension.Y);y++)
		{
			...
			for(k=0;k<pos.Length;k++)
			{
				...
				if( pos[k].X==(x+dx2) && pos[k].Y==(y+dy2) ) continue;
...
//	`LOG_AI("Utility.HeAbilityCircleOfWinter");
