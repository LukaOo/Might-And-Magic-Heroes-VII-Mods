...
public:
	...
	// Virtual Functions  (0x1419402D0)
	virtual void VirtualFunction00 ( );																			// 0x142838770 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x14267B020 (0x08)
	virtual void VirtualFunction02 ( );																			// 0x142678C70 (0x10)
	virtual void VirtualFunction03 ( );																			// 0x142838770 (0x18)
	virtual void VirtualFunction04 ( );																			// 0x1428EBAF0 (0x20)
	virtual void VirtualFunction05 ( );																			// 0x1428EBAF0 (0x28)
	virtual void VirtualFunction06 ( );																			// 0x1426CD380 (0x30)
	virtual void VirtualFunction07 ( );																			// 0x1426CD3F0 (0x38)
	virtual void VirtualFunction08 ( );																			// 0x142649CE0 (0x40)
	virtual void VirtualFunction09 ( );																			// 0x1426D3E00 (0x48)
	virtual void VirtualFunction10 ( );																			// 0x142838770 (0x50)
	virtual void VirtualFunction11 ( );																			// 0x1426BFF70 (0x58)
	virtual void VirtualFunction12 ( );																			// 0x14266C8B0 (0x60)
	virtual void VirtualFunction13 ( );																			// 0x142676F40 (0x68)
	virtual void VirtualFunction14 ( );																			// 0x142632660 (0x70)
	virtual void VirtualFunction15 ( );																			// 0x1428EBAF0 (0x78)
	virtual void VirtualFunction16 ( );																			// 0x1426C7200 (0x80)
	virtual void VirtualFunction17 ( );																			// 0x1426BE770 (0x88)
	virtual void VirtualFunction18 ( );																			// 0x1426CD080 (0x90)
	virtual void VirtualFunction19 ( );																			// 0x1426C72E0 (0x98)
	virtual void VirtualFunction20 ( );																			// 0x1426BF050 (0xA0)
	virtual void VirtualFunction21 ( );																			// 0x1426BE7A0 (0xA8)
	virtual void VirtualFunction22 ( );																			// 0x1426BF010 (0xB0)
	virtual void VirtualFunction23 ( );																			// 0x1428EBAF0 (0xB8)
	virtual void VirtualFunction24 ( );																			// 0x1428EBAF0 (0xC0)
	virtual void VirtualFunction25 ( );																			// 0x1428EBAF0 (0xC8)
	virtual void VirtualFunction26 ( );																			// 0x1428EBAF0 (0xD0)
	virtual void VirtualFunction27 ( );																			// 0x1428EBAF0 (0xD8)
	virtual void VirtualFunction28 ( );																			// 0x1428EBAF0 (0xE0)
	virtual void VirtualFunction29 ( );																			// 0x1426BE790 (0xE8)
	virtual void VirtualFunction30 ( );																			// 0x1426BE7A0 (0xF0)
	virtual void VirtualFunction31 ( );																			// 0x1426BF010 (0xF8)
	virtual void VirtualFunction32 ( );																			// 0x1426BE7A0 (0x100)
	virtual void VirtualFunction33 ( );																			// 0x1426BF010 (0x108)
	virtual void VirtualFunction34 ( );																			// 0x1426C8FE0 (0x110)
	virtual void VirtualFunction35 ( );																			// 0x1426C73F0 (0x118)
	virtual void VirtualFunction36 ( );																			// 0x1426C7630 (0x120)
	virtual void VirtualFunction37 ( );																			// 0x1428EBAF0 (0x128)
	virtual void VirtualFunction38 ( );																			// 0x142666740 (0x130)
	virtual void VirtualFunction39 ( );																			// 0x1428EBAF0 (0x138)
	virtual void VirtualFunction40 ( );																			// 0x1425FADB0 (0x140)
	virtual void VirtualFunction41 ( );																			// 0x1425FADE0 (0x148)
	virtual void VirtualFunction42 ( );																			// 0x1425FAE00 (0x150)
	virtual void VirtualFunction43 ( );																			// 0x142A56480 (0x158)
	virtual void VirtualFunction44 ( );																			// 0x1425FC5B0 (0x160)
	virtual void VirtualFunction45 ( );																			// 0x142A56480 (0x168)
	virtual void VirtualFunction46 ( );																			// 0x1428EBAF0 (0x170)
	virtual void VirtualFunction47 ( );																			// 0x1428EBAF0 (0x178)
	virtual void VirtualFunction48 ( );																			// 0x1428EBAF0 (0x180)
	virtual void VirtualFunction49 ( );																			// 0x142A56480 (0x188)
	virtual void VirtualFunction50 ( );																			// 0x142C74940 (0x190)
	virtual void VirtualFunction51 ( );																			// 0x142C7BCB0 (0x198)
	virtual void VirtualFunction52 ( );																			// 0x1426667D0 (0x1A0)
	virtual void VirtualFunction53 ( );																			// 0x142671020 (0x1A8)
	virtual void VirtualFunction54 ( );																			// 0x1428EBAF0 (0x1B0)
	virtual void VirtualFunction55 ( );																			// 0x1428EBAF0 (0x1B8)
	virtual void VirtualFunction56 ( );																			// 0x142649A90 (0x1C0)
	virtual void VirtualFunction57 ( );																			// 0x142678A40 (0x1C8)
	virtual void VirtualFunction58 ( );																			// 0x1426C0A20 (0x1D0)
	virtual void VirtualFunction59 ( );																			// 0x142A56480 (0x1D8)
	virtual void VirtualFunction60 ( );																			// 0x1426BF000 (0x1E0)
	virtual void VirtualFunction61 ( );																			// 0x1426D0560 (0x1E8)
	virtual void VirtualFunction62 ( );																			// 0x14262FB70 (0x1F0)
	virtual void VirtualFunction63 ( );																			// 0x1426DBBA0 (0x1F8)
	virtual void VirtualFunction64 ( );																			// 0x142A56480 (0x200)
	virtual void VirtualFunction65 ( );																			// 0x1425F9510 (0x208)
	virtual void VirtualFunction66 ( );																			// 0x1425F9550 (0x210)
	virtual void VirtualFunction67 ( );																			// 0x1426E2B00 (0x218)
	virtual void VirtualFunction68 ( );																			// 0x1426BE7D0 (0x220)
	virtual void VirtualFunction69 ( );																			// 0x1426754F0 (0x228)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x14266B5A0 (0x230)
};
