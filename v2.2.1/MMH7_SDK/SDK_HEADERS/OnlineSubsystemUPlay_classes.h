...
// Class OnlineSubsystemUPlay.OnlineGameInterfaceUPlay ( Property size: 12 iter: 34) 
// Class name index: 7859 
...
public:
	...
	unsigned char                                      mCurrentPublishedNatType;                         		// 0x0288 (0x0001) [0x0000000000001000]              ( CPF_Native )
	unsigned long                                      mRDVSessionPublished : 1;                         		// 0x028C (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	void GetUPlayUserID ( struct FString* UserId );
...
// Class OnlineSubsystemUPlay.OnlineSubsystemUPlay ( Property size: 59 iter: 263) 
// Class name index: 7858 
...
public:
	...
	bool IsFriendUPlay ( struct FString PlayerID );
...
// Class OnlineSubsystemUPlay.RDVManager ( Property size: 8 iter: 20) 
// Class name index: 7866 
...
public:
	...
	unsigned long                                      mIsLoggingIn : 1;                                 		// 0x0088 (0x0004) [0x0000000000001000] [0x00000002] ( CPF_Native )
	unsigned long                                      mDisplayedDisconnectMessage : 1;                  		// 0x0088 (0x0004) [0x0000000000001000] [0x00000004] ( CPF_Native )
...
// Class OnlineSubsystemUPlay.UbiservicesManager ( Property size: 7 iter: 18) 
// Class name index: 7870 
// 0x0028 (0x0088 - 0x0060)
class UUbiservicesManager : public UObject
{
public:
	unsigned long                                      mTrackingLocSend : 1;                             		// 0x0060 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      mIsInitialized : 1;                               		// 0x0060 (0x0004) [0x0000000000001000] [0x00000002] ( CPF_Native )
	struct FPointer                                    mUbiservicesFacade;                               		// 0x0064 (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    mUbiservicesLoginTask;                            		// 0x006C (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    mPlayerCredentials;                               		// 0x0074 (0x0008) [0x0000000000001000]              ( CPF_Native )
	class URDVManager*                                 mRDVManager;                                      		// 0x007C (0x0008) [0x0000000000001000]              ( CPF_Native )
	float                                              mLastLoginErrorTime;                              		// 0x0084 (0x0004) [0x0000000000001000]              ( CPF_Native )
...
// Class OnlineSubsystemUPlay.UPlayEventManager ( Property size: 7 iter: 11) 
// Class name index: 7872 
// 0x001D (0x007D - 0x0060)
class UUPlayEventManager : public UObject
{
public:
	unsigned long                                      mOverlayVisible : 1;                              		// 0x0060 (0x0004) [0x0000000000001000] [0x00000001] ( CPF_Native )
	unsigned long                                      mShowedUplayStoppedWorking : 1;                   		// 0x0060 (0x0004) [0x0000000000001000] [0x00000002] ( CPF_Native )
	unsigned long                                      mForceQuitMessageDisplayed : 1;                   		// 0x0060 (0x0004) [0x0000000000001000] [0x00000004] ( CPF_Native )
