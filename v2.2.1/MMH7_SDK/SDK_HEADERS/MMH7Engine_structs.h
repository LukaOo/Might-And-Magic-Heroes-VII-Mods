...
//	 vPoperty_Size=22
	...
	int                                                mMapVersion;                                      		// 0x02F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     mMapAuthor;                                       		// 0x02F8 (0x0010) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                mEnding;                                          		// 0x0308 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
//	 vPoperty_Size=4
	...
	struct FH7MapData                                  AdventureMapData;                                 		// 0x0024 (0x030C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
//	 vPoperty_Size=2
	struct FString                                     Filename;                                         		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FH7MapData                                  MapData;                                          		// 0x0010 (0x030C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
