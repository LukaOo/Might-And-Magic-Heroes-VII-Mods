...
int __fastcall hkDefer ( __int64 pthis, __int64 stach_frame, void* pResult );
int __fastcall hkDeferMore ( __int64 pthis, __int64 stach_frame, void* pResult );
